...
%put NOTE: Episode_of_care(dsn=, tidskrav=28800, debug = 0);
%put NOTE: Parametre:;
...
%put NOTE: 3. debug (=0): Spytter ut midlertidige datasett hvis forskjellig fra null;
...
%put Makroen lager 12 nye variabler:;
...
%put 7.  EoC_inndatotid: inntid (dato og tidspunkt) på første opphold i EoC;
%put 8.  EoC_utdatotid: uttid (dato og tidspunkt) på siste opphold i EoC;
