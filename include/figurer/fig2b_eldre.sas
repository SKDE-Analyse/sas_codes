...
scatter x=plassering y=bohf /datalabel=Andel datalabelpos=center datalabelattrs=(color=white) markerattrs=(size=0) ; 
...
yaxis display=(noticks noline) type=discrete discreteorder=data label="Opptaksområde" labelattrs=(size=&fontst) valueattrs=(size=&fontst) ;
xaxis label = " Antall pr. 1 000 innbyggere ((*ESC*){unicode'2265'x}75 år)" values=(0 to 35000 by 5000) min=0 offsetmin=0 labelattrs=(size=&fontst) valueattrs=(size=&fontst);
