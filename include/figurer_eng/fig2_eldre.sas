...
xaxis label=" Number per 1,000 inhabitants ((*ESC*){unicode'2265'x}75 years old)" labelattrs=(color=black size=&fontst) offsetmin=0.02 OFFSETMAX=0.02  &xskala valuesformat=nlnum8.0   valueattrs=(size=&fontst);
