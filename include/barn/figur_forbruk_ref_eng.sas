proc sgplot data=&bo&fig&RV_fa noborder noautolegend sganno=ANNOARSVAR pad=(Bottom=5%) ;
     ...
     xaxis display=(nolabel) offsetmin=0.02 values=&skala_forbruk min=0  valuesformat=comma8.0 valueattrs=(size=7);
     inset (/*"(*ESC*){unicode'2605'x}" = "   2009" "(*ESC*){unicode'25a0'x}" = "   2010"*/ "(*ESC*){unicode'25a0'x}" = "   2011" 
                ...
                "(*ESC*){unicode'2212'x}(*ESC*){unicode'2212'x}"=" Norway" "(*ESC*){unicode'2500'x}(*ESC*){unicode'2500'x}"=" Ref.value") / position=bottomright textattrs=(size=7);
