...
proc sgplot data=Innlegg noborder noautolegend sganno=ANNOARSVAR pad=(Bottom=5%) ;
	 ...
	 *Refline Universitet / axis=x lineattrs=(Thickness=.5 color=Black pattern=1) name="Ref2";
     ...
     xaxis display=(nolabel) offsetmin=0.02 values=&skala_innlegg min=0  valuesformat=COMMA8.0 valueattrs=(size=7);
     inset ("(*ESC*){unicode'25a0'x}" = "   2011" 
			"(*ESC*){unicode'2666'x}" = "   2012" 
			"(*ESC*){unicode'25cf'x}" = "   2013" 
			"(*ESC*){unicode'25b2'x}" = "   2014" 
            "(*ESC*){unicode'2212'x}(*ESC*){unicode'2212'x}" = " Norway"  
			/*"(*ESC*){unicode'2500'x}(*ESC*){unicode'2500'x}" = " Ref.verdi"*/) 
