...
if KomNr in (2004,2011,2012,2014,2015,2017,2018,2019,2020,2021,2022) then BoShHN=2;
if KomNr in (1902,1922,1924,1925,1926,1927,1928,1929,1931,1933,1936,1938,1939,1940,1941,1942,1943) then BoShHN=3;
if KomNr in (1851,1852,1903,1911,1913,1917) then BoShHN=4;
if KomNr in (1805,1853,1854,1919,1920,1923) then BoShHN=5;
if KomNr in (1866,1867,1868,1870,1871) then BoShHN=6;
if KomNr in (1859,1860,1865,1874) then BoShHN=7;
if KomNr in (1804,1837,1838,1839,1840,1841,1845,1848,1849,1850,1856,1857) then BoShHN=8;
if KomNr in (1828,1832,1833,1836) then BoShHN=9;
if KomNr in (1824,1825,1826) then BoShHN=10;
if KomNr in (1811,1812,1813,1815,1816,1818,1820,1822,1827,1834,1835) then BoShHN=11;
...
If BoShHN in (3,4,5) then BoHF=2;
If BoShHN in (6,7,8) then BoHF=3;
If BoShHN in (9,10,11,12) then BoHF=4;
...
if KomNr in (1567,1601,1612,1613,1617,1620,1621,1622,1624,1627,1630,1634,1635,1636,1638,1640,1644,1648,1653,1657,1662,1663,1664,1665) then BoHF=7;
if KomNr in (1502,1504,1505,1511,1514,1515,1516,1517,1519,1520,1523,1524,1525,1526,1528,1529,1531,1532,1534,1535,1539,1543,1545,1546,1547,1548,1551,
1554,1557,1560,1563,1566,1571,1573,1576) then BoHF=8;
if KomNr in (1401,1411,1412,1413,1416,1417,1418,1419,1420,1421,1422,1424,1426,1428,1429,1430,1431,1432,1433,1438,1439,1441,1443,1444,1445,1449) then BoHF=10;
if KomNr in (1201,1233,1234,1235,1238,1241,1242,1243,1244,1245,1246,1247,1251,1252,1253,1256,1259,1260,1263,1264,1265,1266) then BoHF=11;
if KomNr in (1106,1134,1135,1145,1146,1149,1151,1160,1211,1216,1219,1221,1222,1223,1224,1227,1228,1231,1232) then BoHF=12;
if KomNr in (1101,1102,1103,1111,1112,1114,1119,1120,1121,1122,1124,1127,1129,1130,1133,1141,1142,1144) then BoHF=13;
if KomNr in (101,104,105,106,111,118,119,122,123,124,125,127,128,135,136,137,138) then BoHF=14;
if KomNr in (121,211,213,214,215,216,217,221,226,227,228,229,230,231,233,234,235,237,238,239) then BoHF=15;
/*If KomNr in (301) then do;*/
...
/*	end;*/
if KomNr in (236,402,403,412,415,417,418,419,420,423,425,426,427,428,429,430,432,434,436,437,438,439,441,501,502,511,512,513,514,515,516,517,519,520,521,
522,528,529,533,534,536,538,540,541,542,543,544,545) then BoHF=19;
if KomNr in (219,220,532,602,604,605,612,615,616,617,618,619,620,621,622,623,624,625,626,627,628,631,632,633,711,713) then BoHF=20;
if KomNr in (701,702,704,706,709,714,716,719,720,722,723,728) then BoHF=21;
if KomNr in (805,806,807,811,814,815,817,819,821,822,826,827,828,829,830,831,833,834) then BoHF=22;
if KomNr in (901,904,906,911,912,914,919,926,928,929,935,937,938,940,941,1001,1002,1003,1004,1014,1017,1018,1021,1026,1027,1029,1032,1034,1037,1046) then BoHF=23;

if komNr in (9000,9900,2100,2111,2121,2131,2211,2311,2321) then BoHF=24;
if komNr=9999 then BoHF=99;
