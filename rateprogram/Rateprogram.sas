...
/******  DATAGRUNNLAG  ****************************************************************/
%let Ratefil=skde_kur.test_hofte17_18;
%let RV_variabelnavn= hofte; /*navn på ratevariabel i det aggregerte datasettet*/
%Let ratevariabel = hoftebrudd; /*Brukes til å lage "pene" overskrifter*/
%Let forbruksmal = hoftebrudd; /*Brukes til å lage tabell-overskrift i Årsvarfig, gir også navn til 'ut'-datasett*/
%Let innbyggerfil=Innbygg.innb_2005_2020_bydel_komnr20;
...
%let StartÅr=2017;
%let SluttÅr=2018;
%Let aar=2017; /* Standardiseringsår defineres her*/
%Let aldersspenn=in (0:105); /*Definerer det aktuelle aldersspennet: (0:105) --> 0 til 105 år*/
%Let Alderskategorier=40; /*20, 21, 30, 31, 40, 41, 50, 51 eller 99
