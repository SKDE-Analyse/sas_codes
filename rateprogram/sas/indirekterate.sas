...
%macro indirekterate;
%let flagg=allyr;
* aggregate the file to year, bohf, group (age and gender / age and paritet);
* similar to beginning of utvalgx.sas;
* Q: do we need to use definere_komnr macro, in addition to forny_komnr?;
...
data &dsn_ut(drop= _type_ _freq_ raw_rate_3aar innb_3aar indirjust2014);
