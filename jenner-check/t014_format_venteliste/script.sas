/* jenner-check bundle: t014_format_venteliste
 * Source: formater/venteliste.sas (SKDE-Analyse/sas_codes upstream)
...
/* Driver: apply 2 formats from the venteliste (waiting-list) file. */
data demo;
  input avvikl_kode AV_KODE;
  datalines;
1 1
2 2
3 3
...
proc means data=demo n sum;
  var avvikl_kode AV_KODE;
run;
