/* jenner-check bundle: t010_format_bo_eng
 * Source: formater/bo_eng.sas (SKDE-Analyse/sas_codes upstream)
...
/* Driver: apply 2 boomraade (catchment-area) formats to a small list. */
data demo;
  input BoHF Bydel;
  datalines;
1 1
