/* jenner-check bundle: t001_format_skde_somatikk
 * Source: formater/SKDE_somatikk.sas (SKDE-Analyse/sas_codes upstream)
...
/* Driver: apply 4 formats from this file to a tiny inline dataset. */
data demo;
  input ALD_GR ErMann DRG_typeHastegrad ICD10kap;
  datalines;
1 1 1 9
9 0 4 6
17 1 3 13
...
proc print data=demo label noobs;
  format ALD_GR ALD_GR. ErMann ErMann. DRG_typeHastegrad DRGtypeHastegrad. ICD10kap ICD10kap_kort.;
run;
