/* jenner-check bundle: t002_format_npr_somatikk
 * Source: formater/NPR_somatikk.sas (SKDE-Analyse/sas_codes upstream)
...
value NPRID_REG
   ...
   value $FAGOMRADE
     ...
     '210' = 'Anestesiologi'  
     '220' = 'Barnesykdommer'  
     '230' = 'Fysikalsk medisin og rehabilitering'
     ...
     '380' = 'Palliativ medisin'  /*Ny kode fra 2016*/
     '410' = 'Allergologi'	       /*Ny kode fra 2017*/
     '420' = 'Sykelig overvekt'	 /*Ny kode fra 2017*/
     '430' = 'Smertetilstander'	 /*Ny kode fra 2017*/
     '500' = 'Akutt- og mottaksmedisin'	/*Ny kode fra 2021*/
     '610' = 'Logopedi'	           /*Ny kode fra 2023*/
     '620' = 'Ernæringsfysiologi'  /*Ny kode fra 2023*/
 ...
 /*  value OPPHOLDSTYPE - Variabelen er ikke lenger i bruk. Svært få episoder har informasjon om oppholdstype i 2017. 
   ...
   value UTFORENDEHELSEPERSON /* Antar denne er lik value label for polUtforende */
     ...
     98 = 'Avtalespesialist' /*GCL 25.03.2026 Ved heldekkende analyser kan avtalespesialistene gis kode 98 */
...
/* Driver: apply 2 formats from this file. */
data demo;
  input NPRID_REG KJONN;
  datalines;
1 1
2 2
4 0
...
proc print data=demo label noobs;
  format NPRID_REG NPRID_REG. KJONN KJONN.;
run;
